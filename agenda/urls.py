...
urlpatterns += patterns('agenda.views.pedagogy',
    ...
    (r'^cursuses/(?P<cursus_id>\d+)/update/$',
    ...
    (r'^studyperiods/(?P<studyperiod_id>\d+)/update/$',
       'update_studyperiod', {}, 'update_studyperiod'),
    ...
    (r'^subjects/(?P<subject_id>\d+)/update/$',
    ...
    (r'^subjectmodalities/(?P<subjectmodality_id>\d+)/update/$',
       'update_subjectmodality', {}, 'update_subjectmodality'),

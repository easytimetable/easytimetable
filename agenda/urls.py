...
urlpatterns += patterns('agenda.views.plannings',
    (r'^plannings/users/me/$', 'get_planning', {'what' : 'me'}, 'get_own_planning'),
    (r'^plannings/test/$', 'get_planning', {'what' : 'test'}, 'get_test_planning'),
    (r'^plannings/get/(?P<what>\w+)?$', 'get_planning', {}, 'get_planning'),
